      ...
      <table className="w-full text-xs">
        <thead>
          <tr className="text-gray-500 uppercase tracking-wider border-b border-gray-800">
            ...
            <th className="text-right pb-2">Hype</th>
            <th className="text-right pb-2">Fund.</th>
        ...
        <tbody>
          {valid.map((c) => (
            ...
            >
              ...
              <td className="py-2.5 text-right font-mono text-violet-400">
